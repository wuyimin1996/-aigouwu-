...
<html>
  ...
  <table width="900" border="1" cellspacing="0" cellpadding="0" bordercolor="#006699" style="border-collapse:collapse">
    ...
    <tr>
      <td height="96">
      	<!-- 排序 start -->
      	排序：<a href="productServlet?action=displayProducts&orderfield=myprice&ordervalue=asc&categoryid=${categoryid}">价格升序</a>
      	<a href="productServlet?action=displayProducts&orderfield=myprice&ordervalue=desc&categoryid=${categoryid}">价格降序</a>
      	<a href="productServlet?action=displayProducts&orderfield=hit&ordervalue=asc&categoryid=${categoryid}">人气升序</a>
      	<a href="productServlet?action=displayProducts&orderfield=hit&ordervalue=desc&categoryid=${categoryid}">人气降序</a>
      	<a href="productServlet?action=displayProducts&orderfield=time&ordervalue=asc&categoryid=${categoryid}">上架时间升序</a>	
      	<a href="productServlet?action=displayProducts&orderfield=time&ordervalue=desc&categoryid=${categoryid} ">上架时间降序</a>
      		<!-- 排序结束 -->
				  <!--产品列表 start-->
