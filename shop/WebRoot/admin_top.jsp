...
function logout(){
	...
	top.location = "adminServlet?action=logout";
	return false;
}
</script>
...
<table width="100%" height="64" border="0" cellpadding="0" cellspacing="0" class="admin_topbg">
  <tr>
    ...
    <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="74%" height="38" class="admin_txt">你好：<b>${admin.realname}</b>，登录账号：${admin.username}，角色：<b style="color:red">${admin.role}</b>，感谢登陆使用！</td>
